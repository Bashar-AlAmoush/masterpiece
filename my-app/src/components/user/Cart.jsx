        ...
        <div className="w-full h-full bg-white">
          <div className="w-full h-full">
            ...
            <div className="lg:w-full w-full md:pl-10 pl-4 pr-10 md:pr-4 md:py-12 py-8 bg-white overflow-y-auto overflow-x-hidden h-screen" id="scroll">
              ...
              <div className="md:w-1/3 lg:w-full bg-gray-100 h-full mx-16">
                <div className="flex flex-col md:h-screen py-20 justify-between overflow-y-auto px-12 sm:px-12 md:px-16 lg:px-24">
                  <div>
                    <p className="text-4xl font-black leading-9 text-gray-800">Summary</p>
                    <div className="flex items-center justify-between mt-24">
                      <p className="text-gray-600">Subtotal:</p>
                      <p className="text-gray-800 text-l font-bold"> JD:{calculateSubtotal()}</p>
                    </div>
                    <div className="flex items-center justify-between">
                      <p className="text-gray-600">Tax (2%):</p>
                      <p className="text-gray-800 text-l font-bold"> JD:2.00</p>
                    </div>
