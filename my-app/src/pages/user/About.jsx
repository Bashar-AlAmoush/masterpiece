          ...
          <div className="mt-16 grid border divide-x divide-y rounded-xl overflow-hidden sm:grid-cols-2 lg:divide-y-0 lg:grid-cols-3 xl:grid-cols-4">
            <div className="relative group bg-white transition hover:z-[1] hover:shadow-2xl">
              <div className="relative p-8 space-y-8">
                ...
                <Icon path={mdiBrush} size={2} color={'red'} />

                <div className="space-y-2">
                  <h5 className="text-xl text-gray-800 font-medium transition group-hover:text-red-400">
                    Product Catalog
                  </h5>
                  <p className="text-sm text-gray-600">
                    Display a wide range of art supplies, including paints, brushes, canvases, sketchbooks, easels, and more.
                    Organize products into categories and provide detailed descriptions, images, and pricing information.
                  </p>
                </div>
              </div>
            </div>
            <div className="relative group bg-white transition hover:z-[1] hover:shadow-2xl">
              <div className="relative p-8 space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Implement a secure and user-friendly checkout process. Include a form for customers to enter their billing and shipping details,
                    and provide multiple payment options, such as credit/debit cards, PayPal, or other popular payment gateways.
                  </p>
                </div>
              </div>
            </div>
            <div className="relative group bg-white transition hover:z-[1] hover:shadow-2xl">
              <div className="relative p-8 space-y-8">
                <Icon path={mdiPaletteOutline} size={2} color={'red'} />
                <div className="space-y-2">
                  <h5 className="text-xl text-gray-800 font-medium transition group-hover:text-red-400">
                    Wishlists
                  </h5>
                  <p className="text-sm text-gray-600">
                    Enable users to create wishlists where they can save products they are interested in for future reference or to share with others.
                  </p>
                </div>
              </div>
            </div>
            <div className="relative group bg-white transition hover:z-[1] hover:shadow-2xl lg:hidden xl:block">
              <div className="relative p-8 space-y-8 border-dashed rounded-lg transition duration-300 group-hover:bg-white group-hover:border ">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Ease of use and suitability for user
                    experience
